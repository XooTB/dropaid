    ...
    <main class="container mx-auto mt-8 pb-10">
      <div class="flex flex-wrap">
        ...
        <div class="w-1/2 pl-4 py-5">
          ...
          <p class="text-gray-600 text-sm">SKU: ABC123456</p>
        </div>
      </div>
            ...
            <table class="table-auto">
              <tbody class="py-5 grid grid-cols-2 gap-1">
                <tr class="border border-black rounded-sm">
                  <td class="px-4 py-2 bg-gray-200">Specification 1</td>
                  <td class="px-4 py-2 border-l border-black">Value 1</td>
                </tr>
                <tr class="border border-black rounded-sm">
                  <td class="px-4 py-2 bg-gray-200">Specification 1</td>
                  <td class="px-4 py-2 border-l border-black">Value 1</td>
